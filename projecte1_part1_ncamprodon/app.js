...
const main = async () => {
  ...
  do {
    ...
    switch (opt) {
      case "1":
        const nomTarea = await nouTarea("Tasca:");
        tareas.crearTarea(nomTarea, false);
        // const alumne = new Alumne("Ricard", 10);
        // console.log(alumne);
        console.log();
        console.log(`${"Tasca creada correctament!".yellow}`);
        break;
      ...
      case "4":
        ...
        console.log(`${"------------Tasca completada!------------".yellow}`);
      ...
      case "5":
        ...
        if (id2 !== "0") {
          const confirm = await confirmar(
            `${"Segur que vols eliminar la tasca?".yellow}`
          );
          ...
          if (confirm !== false) {
            ...
            console.log("La tasca no s'ha eliminat");
          }
        }
        break;
